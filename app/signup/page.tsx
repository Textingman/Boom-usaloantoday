        ...
        <div className="bg-white rounded-2xl shadow-xl p-8 md:p-12">
          {submitStatus === 'success' ? (
            <div className="text-center py-12">
              ...
              <Link
                href="/"
                className="inline-block px-6 py-3 bg-[#1E3A8A] text-white font-semibold rounded-lg hover:bg-[#1E40AF] transition-colors"
              >
                Return to Home
              </Link>
            </div>
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      className="block w-full pl-10 pr-3 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#1E3A8A] focus:border-transparent"
                  ...
                  <div className="bg-gray-50 border border-gray-300 rounded-lg p-6">
                    <div className="flex items-start">
                      ...
                      <label htmlFor="terms-consent" className="ml-3 text-sm leading-relaxed text-gray-700">
                        I agree with the{' '}
                        <Link href="/terms" className="text-[#1E3A8A] hover:text-[#1E40AF] font-medium underline">
                          Terms & Conditions
                        </Link>{' '}
                        and{' '}
                        <Link href="/privacy" className="text-[#1E3A8A] hover:text-[#1E40AF] font-medium underline">
                          Privacy Policy
                        </Link>
                        .
                      </label>
                ...
                <button
                  ...
                  className={`w-full py-4 px-6 rounded-lg text-lg font-semibold transition-all ${
                    isSubmitting
                      ...
                      : 'bg-[#1E3A8A] hover:bg-[#1E40AF] text-white shadow-lg hover:shadow-xl'
                  }`}
                >
                  {isSubmitting ? (
