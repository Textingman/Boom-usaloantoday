      ...
      <section className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="prose prose-lg max-w-none">
          ...
          <p className="text-gray-600 mb-6">
            By accessing or using USA Loan Today's SMS verification service ("Service"), you agree to be bound by these Terms of Service ("Terms"). If you do not agree to these Terms, you may not access or use the Service. These Terms apply to all users of the Service, including businesses, developers, and end users.
          </p>

          <h2 className="text-2xl font-bold text-gray-900 mt-8 mb-4">2. Description of Service</h2>
          <p className="text-gray-600 mb-6">
            USA Loan Today provides a carrier-compliant SMS verification platform that allows businesses to verify customer phone numbers through a secure, pass-through verification page. The Service includes:
          </p>
          ...
          <p className="text-gray-600 mb-6">
            The Service and all content, features, and functionality are owned by USA Loan Today and are protected by copyright, trademark, and other intellectual property laws. You may not copy, modify, distribute, or create derivative works based on the Service without our express written permission.
          </p>
          ...
          <p className="text-gray-600 mb-6">
            You agree to indemnify, defend, and hold harmless USA Loan Today and its officers, directors, employees, and agents from any claims, liabilities, damages, losses, and expenses (including reasonable attorney fees) arising from:
          </p>
          <ul className="list-disc pl-6 text-gray-600 mb-6 space-y-2">
          ...
          <p className="text-gray-600 mb-6">
            These Terms, together with our Privacy Policy, constitute the entire agreement between you and USA Loan Today regarding the Service and supersede all prior agreements.
          </p>
          ...
          <div className="bg-gray-50 rounded-lg p-6 mb-8">
            <p className="text-gray-600 mb-2"><strong>Email:</strong> <a href="mailto:legal@usaloantoday.com" className="text-[#1E3A8A] hover:text-[#1E40AF]">legal@usaloantoday.com</a></p>
            <p className="text-gray-600 mb-2"><strong>Support:</strong> <a href="mailto:support@usaloantoday.com" className="text-[#1E3A8A] hover:text-[#1E40AF]">support@usaloantoday.com</a></p>
            <p className="text-gray-600"><strong>Website:</strong> <a href="/" className="text-[#1E3A8A] hover:text-[#1E40AF]">https://usaloantoday.com</a></p>
          </div>
